...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" class="w-45px" src="assets/media/logo1.png" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
								...
								<a href="{{ route('home') }}" class="brand-logo">
									<img alt="Logo" class="w-65px" src="{{ asset('assets/media/logo1.png') }}" />
								</a>
								<!--end::Logo-->
							</div>
												<!--end::Brand-->
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								<li class="menu-item menu-item-active" aria-haspopup="true">
									<a href="index.html" class="menu-link">									<img src="{{ asset('media/svg/icons/flaticon2-architecture-and-city.svg') }}" class="menu-icon" alt="Architecture and City Icon">
		...
		<script src="assets/plugin/plugins.bundle.js"></script>
		<script src="assets/plugin/prismjs.bundle.js"></script>
...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						<!--begin::Logo-->
                        <a href="{{ route('home') }}" class="brand-logo">
                            <img alt="Logo" class="w-65px" src="assets/media/logo1.png" />
                        </a>
						</a>
						<!--end::Logo-->
					</div>
		...
		<!--end::Global Config-->
		<!--begin::Global Theme Bundle(used by all pages)-->
		<script src="{{ asset('assets/plugin/plugins.bundle.js') }}"></script>
		<script src="{{ asset('assets/plugin/prismjs.bundle.js') }}"></script>
